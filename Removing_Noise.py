...
df['K'].fillna(df['K'].mean())
df['N'].fillna(df['N'].mean())
df['P'].fillna(df['P'].mean())
...
#Removing Outliers
df.loc[df['N']>140, 'N']=np.mean(df['N'])
df.loc[df['P']>140, 'P']=np.mean(df['P'])
df.loc[df['K']>175, 'K']=np.mean(df['K'])
df.loc[df['temperature']>45, 'temperature']=np.mean(df['temperature'])
df.loc[df['temperature']<10, 'temperature']=np.mean(df['temperature'])
df.loc[df['ph']>9, 'ph']=np.mean(df['ph'])
df.loc[df['ph']<4, 'ph']=np.mean(df['ph'])
df.loc[df['humidity']<20, 'humidity']=np.mean(df['humidity'])
df.loc[df['rainfall']>270, 'rainfall']=np.mean(df['rainfall'])
